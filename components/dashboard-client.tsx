...
import { Eye, LogOut, Plus, Settings, Trash2, ArrowLeft, Moon, Sun, User, Radio } from "lucide-react"
...
export function DashboardClient({ vendor, totalViews, weeklyViews, userId }: DashboardClientProps) {
