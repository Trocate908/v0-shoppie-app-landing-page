    ...
    <div className="p-6 max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Run this SQL once to create the admin tables and add required columns.
        </p>
      </div>

      <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-xl p-4">
        <p className="text-sm font-medium text-amber-800 dark:text-amber-300 mb-2">⚠ One-time setup required</p>
        <p className="text-sm text-amber-700 dark:text-amber-400">
          The admin control center needs 4 tables and 2 extra columns. Copy the SQL below and run it in your
          Supabase SQL Editor. You only need to do this once.
        </p>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl p-5 space-y-3">
        ...
        <ol className="space-y-2 text-sm text-muted-foreground list-decimal list-inside">
          ...
          <li>Click <strong className="text-foreground">Copy SQL</strong> and paste it into the SQL editor</li>
          <li>Click <strong className="text-foreground">Run</strong> to execute the migration</li>
          <li>Return here and navigate to any admin section — it will work immediately</li>
        </ol>
        ...
        <div className="pt-2 border-t border-border">
          <p className="text-xs text-muted-foreground">
            ...
            <code className="bg-muted px-1 rounded">reports</code>,{" "}
            <code className="bg-muted px-1 rounded">platform_settings</code>,{" "}
            <code className="bg-muted px-1 rounded">announcements</code> tables, plus{" "}
            <code className="bg-muted px-1 rounded">is_hidden</code> and{" "}
            <code className="bg-muted px-1 rounded">is_featured</code> columns on{" "}
