      ...
      export default async function ProductDetailPage({
        ...
        const [{ data: categoryProducts }, { data: vendorProducts }] =
          await Promise.all([
            // Same category products from any shop.
            product.category
              ? supabase
                  .from("products")
                  .select(`
            ...
            // Same vendor products, used to fill remaining slots.
            supabase
              .from("products")
              .select(`
                *,
        ...
        // Same-category products first, then vendor products.
        // Deduplicate by product ID and cap at 8.
